...
def install_packages():
    try:
        ...
        #subprocess.check_call([sys.executable, 'install', '--upgrade', 'pip', 'setuptools'])
        #print("pip and setuptools upgraded successfully.")
        #subprocess.check_call([sys.executable, 'install', 'pipreqs'])
        ...
        subprocess.check_call([sys.executable,'install','azure.identity'])
        subprocess.check_call([sys.executable,'install','azure.keyvault.secrets'])
        subprocess.check_call([sys.executable,'install','pyodbc'])
        subprocess.check_call([sys.executable,'install','email_validator'])
